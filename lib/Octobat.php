...
class Octobat
{
    // @var string The Octobat API key to be used for requests.
    public static $apiKey;

    // @var string The base URL for the Octobat API.
    public static $apiBase = 'https://apiv2.octobat.com';

    // @var string|null The version of the Octobat API to use for requests.
